...
bool VisSampleApp::Run()
{
 ...
 // vHavokMarkWorld w = new vHavokMarkWorld(true);
  //float x = Vision::Game.GetRand()%1000 - 500;
  //float y = Vision::Game.GetRand()%1000 - 500;
  //float z = Vision::Game.GetRand()%1000 - 500;
  //hkvVec3 gravity = hkvVec3(x,y,z);
  //vHavokPhysicsModule* modu = vHavokPhysicsModule::GetInstance();
  //modu->SetGravity(gravity);
